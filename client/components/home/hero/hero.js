...
const Hero = () => {
  ...
  const greeting = account ? <p>You are connected with the following account<br/><span className={styles.address}>{account}</span></p>: <p>"Please connect with your Metamask to continue"</p>;
